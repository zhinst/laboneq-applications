...
def set_dc_bias(session, slot, voltage):
    # mylogger.info(f"Called 'user_func' with params: voltage={voltage:.2f}")
    # dc_source.set_smooth(voltagedict)
    return f"voltage={voltage:.3f}"
