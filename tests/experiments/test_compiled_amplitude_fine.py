...
@pytest.mark.parametrize("repetitions", [np.arange(1, 16, 1),np.arange(1, 25, 1),np.arange(1, 50, 1)])
...
class TestAmplitudeFine:
    ...
    def _set_options(self, transition, cal_states):
        ...
        self.options.create_experiment.count = 1  # No need to be parameterized here
    ...
    def create_fine_amplitude_verifier(self, repetitions, num_qubits):
        self.qubits[0].parameters.ge_drive_length = 32e-9
    ...
    # @pytest.mark.skip("test another module")
