...
class TestValidateAndConvertQubitSweeps:
    def test_single_qubit(self, single_tunable_transmon):
        [q0] = single_tunable_transmon.qubits
        qubits, sweeps = validate_and_convert_qubits_sweeps(q0, [1, 2, 3])
        assert qubits == [q0]
        assert sweeps == [[1, 2, 3]]

    def test_single_qubit_with_numpy_array(self, single_tunable_transmon):
        [q0] = single_tunable_transmon.qubits
    ...
    def test_sequence_of_qubits(self, two_tunable_transmon):
    ...
    def test_sequence_of_qubits_with_numpy_arrays(self, two_tunable_transmon):
        [q0, q1] = two_tunable_transmon.qubits
        sweep_0 = np.array([1, 2, 3])
    ...
    def test_single_qubit_with_sequence_of_sweeps_error(self, single_tunable_transmon):
        [q0] = single_tunable_transmon.qubits
    ...
    def test_number_of_qubits_and_sweeps_not_equal_error(self, single_tunable_transmon):
        [q0] = single_tunable_transmon.qubits
    ...
    def test_not_all_sweeps_valid(self, single_tunable_transmon):
        [q0] = single_tunable_transmon.qubits
