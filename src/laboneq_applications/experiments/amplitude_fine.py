...
def experiment_workflow(  # noqa: PLR0913
    ...
    *,
    ...
    default_evaluation_parameter: str = "ge_drive_amplitude_pi"
    default_evaluation_parameter_threshold: float = 0.001
    default_evaluation_fit_r2_threshold: float = 0.01
